...
def test_relation_lookup():
    ...
    ref = {
        "RELATES": ("ARTICLE", "CATEGORY"),
        "DESCRIBES": ("ARTICLE", "PROCESS"),
        "MENTIONS": ("ARTICLE", "AGENT"),
        "REFERENCES": ("ARTICLE", "RESOURCE"),
        "ACTIVATES": ("PROCESS", "PROCESS"),
        "INHIBITS": ("PROCESS", "PROCESS"),
        "REGULATES": ("PROCESS", "PROCESS"),
        "INVOLVES": ("PROCESS", "AGENT"),
        "BINDS": ("AGENT", "AGENT"),
        "MODIFIES": ("AGENT", "AGENT"),
        "GENERATES": ("PROCESS", "AGENT"),
        "REMOVES": ("PROCESS", "AGENT"),
        "RESOURCE_DESCRIBES": ("RESOURCE", "PROCESS"),
        "RESOURCE_MENTIONS": ("RESOURCE", "AGENT"),
    }
