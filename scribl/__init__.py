...
prefix = ":"
statement_prefix = f"{prefix}{prefix}"
field_prefix = prefix
tag_delimiter = ";"
zotero_tag_max = 255
...
def generate_statement(item):
    return f"{statement_prefix}{item}"


def generate_field(item):
    return f"{field_prefix}{item}"
